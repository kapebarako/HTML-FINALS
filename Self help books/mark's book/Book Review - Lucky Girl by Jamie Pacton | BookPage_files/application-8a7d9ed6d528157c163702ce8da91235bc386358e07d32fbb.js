...
$(window).load(function() {
    // $('#facet-box').scrollToFixed({
    //     marginTop: function() {
    //         var marginTop = $(window).height() - $('#facet-box').outerHeight(true) - 250;
    //         if (marginTop >= 0) return 10;
    //         return marginTop;
    //     }
    // });
    // $('#facet-box').scrollToFixed();
...
$(window).load(function() {
    // $('#facet-box2').scrollToFixed({
    //     marginTop: function() {
    //         var marginTop = $(window).height() - $('#facet-box2').outerHeight(true) - 25;
    //         if (marginTop >= 0) return 10;
    //         return marginTop;
    //     }
    // });
...
$(window).load(function() {
    $('#desktop2').scrollToFixed({
        marginTop: function() {
            var marginTop = $(window).height() - $('#desktop2').outerHeight(true) - 20;
...
$(document).ready(function() {
  var input = $('.e2ma_signup_form_element #id_email');
...
var externalLinks = $('[rel="external"]');

for (i = 0; i < externalLinks.length; i++) {
    var link = externalLinks.eq(i);
    var method = 'trackOutboundLink("' + link.attr("href") + '"); return false;';
    link.attr("onclick", method);
}
;
